...
While the gamma approximation has been applied to infer \RR\ in real outbreak settings (\tref{review}), 
its theoretical properties and practical importance has not been explored yet.
\jsw{Not necessary and the sentence has multiple grammar errors in any case}
\swp{How about this?}
