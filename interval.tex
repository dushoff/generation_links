...
One way to compute the moments of generation interval distributions given latent and infectious period distributions is by simulating a theoretical sample \cite{HampDush09}.
...
Moments of this sample is then substituted into \eref{gamApp}.
