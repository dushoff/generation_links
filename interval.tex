...
We test our approximation method by generating pseudo-realistic generation-interval distributions, using observed generation intervals (or else latent and infectious intervals) from specific disease. 
...
We evaluate our approximations, we compare results from ga
