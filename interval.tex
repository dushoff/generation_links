...
\begin{figure}[htbp] \centering
	...
	\caption{Estimating \RR~for rabies.
		...
		Gray solid curve: the empirical speed-strength relationship \eref{Euler} using a realistic generation-interval distribution.
Black solid curve and dashed curve: the gamma approximated speed-strength relationship \eref{gamApp}, using the mean and CV of a realistic generation-interval distribution. 
