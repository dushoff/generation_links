...
Here, we explore the qualitative relationship between generation time, initial rate of spread $r$, and initial reproductive number \RR\ using means, variance measures and gamma approximations.
...
Third, it generalizes the result obtained from simple SIR models, and approximately matches SEIR, in the case where the latent period and infectious period are similar.
