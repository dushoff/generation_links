...
In disease outbreaks, the rate of spread is often inferred from case-incidence reports, by fitting an exponential function to the incidence curve \cite{Ma,WhoElse} and used to estimate the reproductive number, \RR.
