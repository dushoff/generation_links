...
\swp{I don't know how to add figures with make... Should this be a figure caption?}

Approximating a generation intervals distribution with a normal distribution can be problematic as it supports negative values, which are biologically impossible. As a consequence, the normal approximation eventually predicts a decreasing $r-\RR$ relationship for large $r$.
