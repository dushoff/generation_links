...
Approximating a generation intervals distribution with a normal distribution can be problematic as it supports negative values, which are biologically impossible. As a consequence, the normal approximation predicts a decreasing $r-\RR$ relationship for large $r$.
