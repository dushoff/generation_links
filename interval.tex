...
\swp{Nevertheless, we caution the readers that this result should not be taken too seriously. This example is presented to illustrate that summarizing a distribution with its moments may be sufficient to capture its essential information.}
