...
\hotcomment{Note that this is an exact method for sampling from the intrinsic generation interval given infectious and latent period! I can probably give a formal proof for it as well; is this unnecessary? Do we want to let people know that this is an available method that they can use?}
