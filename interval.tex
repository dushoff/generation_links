...
What is missing is a general idea that can unify these results and a clear biological interpretation.
}
...
However, as decreasing coefficient of variation of infectious period leads to shorter mean generation interval as well \cite{Sven07}, assuming a tighter infectious period distribution may predict smaller \RR \cite{wearing2005appropriate}.
...
\cite{roberts2007model} showed that decreasing coefficient of variation of infectious period results in higher \RR, assuming that mean generation interval is fixed (hence only affecting variation in generation intervals).

As \cite{roberts2007model} assumed that mean generation interval is fixed, decreasing coefficient of variation of infectious period only affects variation in generation intervals and predicts higher \RR.
As \cite{wearing2005appropriate} assumed that mean infectious period is fixed, decreasing coefficient of variation of infectious period decreases both mean and variation in generation intervls and does not necessarily predict higher \RR.
