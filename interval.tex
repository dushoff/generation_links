...
\hline
Reproduction number & 1.38, 1.51, 1.81 \cite{WHO14} & & 1.06, 1.32 \cite{Katie} \\
Mean incubation period (days) & 11.4 \cite{WHO14} & 12.77 \cite{LessReic09inc}  & 24.24 \cite{Katie} \\
SD incubation perid (days) & 7.5 [assumption] & 2.67 \cite{LessReic09inc} & 29.49 \cite{Katie} \\
Mean infectious period (days) & 5 \cite{WHO14} & 3.65 \cite{lloyd2001realistic} & 3.57 \cite{Katie} \\
SD infectious period (days) & 4.7 \cite{WHO14} & 1.63 \cite{lloyd2001realistic} & 2.26 \cite{Katie}
\end{tabular}
